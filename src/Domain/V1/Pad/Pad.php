...
class Pad
{
    ...
    /**
     * @var PadGroup
     * @Field(name="pad_group", type="MyTarget\Domain\V1\Pad\PadGroup")
     */
    private $padGroup;

    /**
     * @var EyeUrl
     * @Field(name="eye_url", type="MyTarget\Domain\V1\Pad\EyeUrl")
     */
    private $eyeUrl;
