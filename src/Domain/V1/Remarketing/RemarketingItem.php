...
class RemarketingItem
{
     ...
     * @Field(name="remarketing_game_payers", type="array<MyTarget\Domain\V1\Remarketing\RemarketingGameInterval>")
     */
    private $gamePayers;

    /**
     * @var RemarketingGameInterval[]
     * @Field(name="remarketing_game_players", type="array<MyTarget\Domain\V1\Remarketing\RemarketingGameInterval>")
     */
    private $gamePlayers;

    /**
     * @var RemarketingInterval[]
     * @Field(name="remarketing_payers", type="array<MyTarget\Domain\V1\Remarketing\RemarketingInterval>")
     */
    private $payers;

    /**
     * @var RemarketingInterval[]
     * @Field(name="remarketing_players", type="array<MyTarget\Domain\V1\Remarketing\RemarketingInterval>")
     */
    private $players;

    /**
     * @var RemarketingGroupMembership[]
     * @Field(name="remarketing_groups", type="array<MyTarget\Domain\V1\Remarketing\RemarketingGroupMembership>")
     */
    private $groups;
     ...
     * @Field(name="remarketing_context_phrases", type="array<MyTarget\Domain\V1\Remarketing\RemarketingContextPhrasesInterval>")
     */
    private $contextPhrases;

    /**
     * @var RemarketingPricelistInterval[]
     * @Field(name="remarketing_pricelists", type="array<MyTarget\Domain\V1\Remarketing\RemarketingPricelistInterval>")
     */
    private $pricelists;

    /**
     * @var RemarketingMobileApps[]
     * @Field(name="remarketing_mobile_apps", type="array<MyTarget\Domain\V1\Remarketing\RemarketingMobileApps>")
     */
    private $mobileApps;
     ...
     * @Field(name="remarketing_vk_groups", type="array<MyTarget\Domain\V1\Remarketing\RemarketingVkGroup>")
     */
    private $vkGroups;

    /**
     * @var RemarketingVkApp[]
     * @Field(name="remarketing_vk_apps", type="array<MyTarget\Domain\V1\Remarketing\RemarketingVkApp>")
     */
    private $vkApps;
