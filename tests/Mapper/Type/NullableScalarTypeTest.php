...
class NullableScalarTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $nullableScalarType = new NullableScalarType();

        $result = $nullableScalarType->hydrated($value, $type, $this->mapper);
    ...
    public function testItMakesSnapshot($value, $snapshot)
    {
        ...
        $result = $nullableScalarType->snapshot($value, 'anyType', $this->mapper);
    ...
    public function hydratedValues()
    {
        ...
        return [
            ...
            'nullable integer from null' => ['int', null, null],
            ...
            'nullable boolean from null' => ['bool', null, null],
            ...
            'nullable float from null' => ['float', null, null],
            ...
            'nullable string from null' => ['string', null, null],
